...
describe('http-server-express (integration)', () => {
  ...
  function givenEndpoint(config: HttpServerConfig, handler: HttpHandler) {
    return factory.createEndpoint(config || {}, handler);
  }
});
