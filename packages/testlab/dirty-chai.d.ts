...
// Type definitions for chai + dirty-chai
...
declare namespace DirtyChai {
    ...
    interface AssertionFn { (): Assertion }
...
declare var chai: DirtyChai.ChaiStatic;

declare module "dirty-chai-api" {
    export = chai;
}

interface Object {
    should: DirtyChai.Assertion;
}
