...
> extends Repository<T> {
   ...
   */
  find(filter?: Filter<T>, options?: Options): Promise<FindResult[]>;
...
export interface EntityCrudRepository<
  ...
  ID,
  FindResult extends T = T
> extends EntityRepository<T, ID>, CrudRepository<T, FindResult> {
   ...
   */
  findById(id: ID, filter?: Filter<T>, options?: Options): Promise<FindResult>;
