...
exports[`lb4 relation HasMany check if the controller file created  answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order"} checks controller content with hasMany relation 1`] = `
import {
  Count,
  CountSchema,
  Filter,
...
exports[`lb4 relation HasMany check if the controller file created  answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass"} checks controller content with hasMany relation 1`] = `
import {
  Count,
  CountSchema,
  Filter,
...
exports[`lb4 relation HasMany check if the controller file created  answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType"} checks controller content with hasMany relation 1`] = `
import {
  Count,
  CountSchema,
  Filter,
...
exports[`lb4 relation HasMany check source class repository  answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order"} checks if Customer repository has generated correctly 1`] = `
...
exports[`lb4 relation HasMany check source class repository  answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass"} checks if CustomerClass repository has generated correctly 1`] = `
import {DefaultCrudRepository, repository, HasManyRepositoryFactory} from '@loopback/repository';
...
exports[`lb4 relation HasMany check source class repository  answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType"} checks if CustomerClassType repository has generated correctly 1`] = `
import {DefaultCrudRepository, repository, HasManyRepositoryFactory} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order"} add import hasMany, import for target model and hasMany decorator 1`] = `
...
exports[`lb4 relation HasMany generate model relation answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass"} add import hasMany, import for target model and hasMany decorator 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType"} add import hasMany, import for target model and hasMany decorator 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation with custom foreignKey answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order","foreignKeyName":"mykey"} add the keyTo to the source model 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {Order} from './order.model';
...
exports[`lb4 relation HasMany generate model relation with custom foreignKey answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order","foreignKeyName":"mykey"} add the keyTo to the source model 2`] = `
...
exports[`lb4 relation HasMany generate model relation with custom foreignKey answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass","foreignKeyName":"mykey"} add the keyTo to the source model 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {OrderClass} from './order-class.model';
...
exports[`lb4 relation HasMany generate model relation with custom foreignKey answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass","foreignKeyName":"mykey"} add the keyTo to the source model 2`] = `
import {Entity, model, property} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation with custom foreignKey answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType","foreignKeyName":"mykey"} add the keyTo to the source model 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {OrderClassType} from './order-class-type.model';
...
exports[`lb4 relation HasMany generate model relation with custom foreignKey answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType","foreignKeyName":"mykey"} add the keyTo to the source model 2`] = `
import {Entity, model, property} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation with custom relation name answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order","relationName":"myOrders"} relation name should be myOrders 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {Order} from './order.model';
...
exports[`lb4 relation HasMany generate model relation with custom relation name answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order","relationName":"myOrders"} relation name should be myOrders 2`] = `
import {Entity, model, property} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation with custom relation name answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass","relationName":"myOrders"} relation name should be myOrders 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {OrderClass} from './order-class.model';
...
exports[`lb4 relation HasMany generate model relation with custom relation name answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass","relationName":"myOrders"} relation name should be myOrders 2`] = `
import {Entity, model, property} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation with custom relation name answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType","relationName":"myOrders"} relation name should be myOrders 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {OrderClassType} from './order-class-type.model';
...
exports[`lb4 relation HasMany generate model relation with custom relation name answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType","relationName":"myOrders"} relation name should be myOrders 2`] = `
import {Entity, model, property} from '@loopback/repository';
...
exports[`lb4 relation HasMany generate model relation with default relation name answers {"relationType":"hasMany","sourceModel":"Customer","destinationModel":"Order"} relation name should be orders 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {Order} from './order.model';
...
exports[`lb4 relation HasMany generate model relation with default relation name answers {"relationType":"hasMany","sourceModel":"CustomerClass","destinationModel":"OrderClass"} relation name should be orderClasses 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {OrderClass} from './order-class.model';
...
exports[`lb4 relation HasMany generate model relation with default relation name answers {"relationType":"hasMany","sourceModel":"CustomerClassType","destinationModel":"OrderClassType"} relation name should be orderClassTypes 1`] = `
import {Entity, model, property, hasMany} from '@loopback/repository';
import {OrderClassType} from './order-class-type.model';
