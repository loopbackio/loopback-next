...
module.exports = class RepositoryRelation extends ArtifactGenerator {
    ...
    generateRelationRepository(sourceModel, targetModel, foreignKey, relationName) {
        ...
        if (relationName != relationType.hasOne &&
    ...
    doesImportExistInModule(sourceFile, currentImport) {
        let identicalImport;
        let relevantImports = getNamedImportsFromModule(sourceFile, currentImport.module);
    ...
    addRequiredProperties(sourceFile, sourceModel, targetModel, relationName) {
        let classDeclaration = sourceFile.getClassOrThrow(capitalizeFirstLetter(sourceModel) + "Repository");
    ...
    getTargetPropertyType(sourceModel, targetModel, relationName) {
        ...
        else if (relationName == relationType.hasOne ||
            relationName == relationType.hasMany) {
        ...
        propertyType += "<" + capitalizeFirstLetter(targetModel) +
            ", typeof " + capitalizeFirstLetter(sourceModel) + ".prototype.id>";
    ...
    editConstructor(sourceFile, sourceModel, targetModel, relationName) {
        ...
        let classDeclaration = sourceFile.getClassOrThrow(capSourceModel + "Repository");
    ...
    addCreator(classConstructor, targetModel, relationName) {
        ...
        else if (relationName == relationType.hasMany ||
        ...
        let creatorStatement = "this." + propertyName + "=" +
            method + parameter1 + paramater2 + ");";
