...
export interface TagDecoratorOptions {
  append: boolean;
}

export function tags(tagNames: string[], options?: TagDecoratorOptions) {
  return function tagsDecoratorForClassOrMethod(
    ...
    if (method && methodDescriptor) {
      ...
      return MethodDecoratorFactory.createDecorator<TagsDecoratorMetadata>(
        ...
        {tags: tagNames, append: options?.append ?? false},
        {decoratorName: '@tags'},
      ...
      throw new Error(
        '@tags cannot be used on a property: ' +
