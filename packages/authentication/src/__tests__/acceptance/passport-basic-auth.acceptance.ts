...
import { authenticate, AuthenticateFn, AuthenticationBindings, AuthenticationComponent, AuthenticationMetadata, AuthenticationStrategy, AuthenticationStrategyProvider, StrategyAdapter, UserProfile } from '../..';
...
describe('Basic Authentication', () => {
  ...
  function givenProviders() {
    ...
    server.bind(AuthenticationBindings.STRATEGY).toProvider(AuthenticationStrategyProvider);
    server
