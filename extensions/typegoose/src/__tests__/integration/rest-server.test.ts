...
import {TestTypegooseApplication} from './application';
describe('Typegoose Extension (Acceptance)', () => {
  let app: TestTypegooseApplication;
  let client: Client;
  ...
  beforeEach(async () => {
    ...
    app = new TestTypegooseApplication({
