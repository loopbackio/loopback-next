...
describe('Basic Authentication', () => {
    ...
    async function givenAServer() {
        ...
        core_1.addExtension(app, authentication_1.AuthenticationBindings.AUTHENTICATION_STRATEGY_EXTENSION_POINT_NAME, PassportBasicAuthProvider, {
            namespace: authentication_1.AuthenticationBindings.AUTHENTICATION_STRATEGY_EXTENSION_POINT_NAME,
        });
